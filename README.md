...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pardiso4py-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10665&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pardiso4py-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pardiso4py` can be installed with:

```
conda install pardiso4py
```

It is possible to list all of the versions of `pardiso4py` available on your platform with:
